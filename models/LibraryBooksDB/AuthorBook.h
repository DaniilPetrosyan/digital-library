...
class AuthorBook
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//book_id,author_id
     ...
     */
    explicit AuthorBook(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AuthorBook(const Json::Value &pJson) noexcept(false);
     ...
     */
    AuthorBook(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<AuthorBook>;
    friend drogon::orm::BaseBuilder<AuthorBook, true, true>;
    friend drogon::orm::BaseBuilder<AuthorBook, true, false>;
    friend drogon::orm::BaseBuilder<AuthorBook, false, true>;
    friend drogon::orm::BaseBuilder<AuthorBook, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AuthorBook>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where book_id = $1 and author_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where book_id = $1 and author_id = $2";
        return sql;
    }
